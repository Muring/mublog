...
date: "2025-04-30"
description: "GCP VM을 활용한 Docker 응용"
tags:
  - docker
  - GCP
  - devOps
...
해당 키를 생성하지 않은 사람들을 위한 생성 방법은 [여기](https://www.notion.so/SSH-1e3fcbf1b92480b08e11c689ad1f7349?pvs=21)를 통해 생성해서 돌아오도록 하자.
...
Docker를 서버에 설치하고 배포하는 과정은 다음 편, [**Docker 응용: GCP VM에 Docker 설치**](https://www.notion.so/Docker-GCP-VM-Docker-1e3fcbf1b924808a9375e4c1d7d43280?pvs=21)에서 이어 하도록 하겠다.