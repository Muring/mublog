...
이렇게 성공적으로 서버에 Docker의 설치를 완료했다. 이제 설치한 Docker를 배포하기 전, 파일을 적재하는 방법으로 [Docker 응용: GCP VM에 파일 빌드](https://muring-blog.vercel.app/docker-gcp-02-docker-installation)로 이어서 작성하도록 하겠다.