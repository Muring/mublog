...
tags:
    - salesforce
    - project
thumbnail: "https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/thumbnails/salesforce-system-localization-center/thumbnail-b52b9d9a.png"
---
...
![*"화면 구성 예시"*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-system-localization-center/image-1-5d2cd69f.png)
...
![image.png](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-system-localization-center/image-2-e7d1dd55.png)
...
- Record 기반인데 ResourceCode가 시스템 코드와 중복이면: **OVERWRITE 태그 표시**
    ...
    ![*"Overwrite 태그 예시"*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-system-localization-center/image-3-2035ff30.png)
    _"Overwrite 태그 예시"_
...
- 템플릿은 `{VariableName}` 형태의 플레이스홀더를 포함
    ...
    ![image.png](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-system-localization-center/image-4-52d94b9a.png)
    _"템플릿 예시"_
...
- 에러 메시지는 `{Error}`를 템플릿에 넣으면, 시스템이 자동 주입
    ...
    ![image.png](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-system-localization-center/image-5-fdd85691.png)
    _"Error 예시"_
