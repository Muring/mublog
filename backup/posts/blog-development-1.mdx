...
tags:
    - frontend
    - etc
thumbnail: "https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/thumbnails/blog-development-1/illustration-77f21b68a8cd.png"
series: "블로그 개발기"
seriesOrder: 1
---
...
그래서 뭘 하고 싶길래 이런 블로그를 만드느냐?  
목표는 **프론트엔드 개발자!**

프론트엔드 경력은 일천하지만 지금부터라도 노력하고 이것저것 하다보면 몇 년 뒤에는 갈 수 있겠지.
