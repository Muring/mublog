...
-   Setup → App Manager → New External Client App
    ![*“”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-ci-cd-basic/image-1-688d750f.png)
-   OAuth 설정 활성화
-   **Consumer Key (Client Id)** 는 이후 인증에 필요하니 저장해 놓자.
-   Callback URL은 임의값이어도 되지만, 조직 정책에 맞게 설정한다.
    ![*“”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-ci-cd-basic/image-2-59080960.png)
-   필요한 Scope는 최소 권한 원칙으로(예: api, refresh_token 등 조직 정책에 맞춰)
    ![*“”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-ci-cd-basic/image-3-34793208.png)
...
-   `server.crt`를 Connected App에 업로드(인증서)
    ![*“”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-ci-cd-basic/image-4-f1b0b342.png)
...
-   Require secret for Refresh Token Flow 체크 해제
    ![*“”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-ci-cd-basic/image-5-95caa178.png)
...
-   IP Relaxation : `Relax IP restrictions`
    ![*“”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-ci-cd-basic/image-6-b2d146a7.png)
...
-   `SF_JWT_KEY` : `server.key` 내용(파일 자체를 저장하지 않고 **문자열로 저장**하는 방식 추천)
    ![*“”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/salesforce-ci-cd-basic/image-7-a1b87600.png)
