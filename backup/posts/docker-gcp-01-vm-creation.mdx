...
tags:
    - devOps
thumbnail: "https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/thumbnails/shared/docker-gcp-f7aef7a4.png"
series: "Docker + GCP 배포"
seriesOrder: 1
---
...
![*“Cloud Storage 무료 버전 조건”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/docker-gcp-01-vm-creation/image-1-ec08707b.png)
...
![*“Welcome page”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/docker-gcp-01-vm-creation/image-2-d7d2deb9.png)

*“Welcome page”*

![*“Compute Engine API”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/docker-gcp-01-vm-creation/image-3-fc477c8f.png)
...
![*“공식 문서”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/docker-gcp-01-vm-creation/image-4-ab5971a6.png)
...
![image.png](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/docker-gcp-01-vm-creation/image-5-7e8b804a.png)
...
![*“성공적으로 저장된 SSH 키”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/docker-gcp-01-vm-creation/image-6-c504eb22.png)
...
![image.png](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/docker-gcp-01-vm-creation/image-7-5d3ea42c.png)
...
![*“SSH 키 등록 시 사용자 이름@ VM 인스턴스 이름”*](https://qzheelrrsgtlzufhcszl.supabase.co/storage/v1/object/public/post-images/posts/docker-gcp-01-vm-creation/image-8-22e8775e.png)
